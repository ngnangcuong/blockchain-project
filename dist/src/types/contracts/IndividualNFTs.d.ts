...
export interface IndividualNFTsInterface extends Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "BatchMetadataUpdate" | "MetadataUpdate" | "NFTMinted" | "Transfer"): EventFragment;
...
export interface IndividualNFTs extends BaseContract {
    connect(runner?: ContractRunner | null): IndividualNFTs;
    waitForDeployment(): Promise<this>;
    interface: IndividualNFTsInterface;
    ...
    mint: TypedContractMethod<[_tokenURI: string], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "mint"): TypedContractMethod<[_tokenURI: string], [void], "nonpayable">;
    ...
    filters: {
        ...
        "NFTMinted(uint256)": TypedContractEvent<NFTMintedEvent.InputTuple, NFTMintedEvent.OutputTuple, NFTMintedEvent.OutputObject>;
